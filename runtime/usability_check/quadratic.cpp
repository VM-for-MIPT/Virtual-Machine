...
int main() {
    ...
    byte_code.push_back(vm::FLOADGen(
        reinterpret_cast<uint32_t>(4U))); // saved 4U to faccum
    ...
    byte_code.push_back(vm::FLOADGen(
        reinterpret_cast<uint32_t>(0U))); // saved 0U to faccum
    ...
    byte_code.push_back(vm::FLOADGen(
        reinterpret_cast<uint32_t>(2U))); // saved 2U to faccum
