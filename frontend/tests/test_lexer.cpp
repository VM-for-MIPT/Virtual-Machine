...
TEST(GetLexemes, ID)
{
    ...
    std::vector<std::pair<int, std::string>> true_lexemes = {
        {ID, "plis_plos"}, {ID, "qwerty"}, {OPERATOR, "-"}, {ID, "iops"}, {ID, "string"},
    };
...
TEST(GetLexemes, FLOAT)
{
    ...
    std::vector<std::pair<int, std::string>> true_lexemes = {{FLOAT, "1234.0987"}, {FLOAT, "4783.47"}, {NUMBER, "666"},
                                                             {OPERATOR, "."},      {ID, "qwerty"},     {FLOAT, "7.7"}};
...
TEST(GetLexemes, STRING)
{
    ...
    std::vector<std::pair<int, std::string>> true_lexemes = {
        {STRING, "\"qwerty\""}, {STRING, "\"\""}, {STRING, "\"Hello World\\n\""}, {STRING, "don't\ndo that"}};
...
TEST(GetLexemes, text1)
{
    ...
    std::vector<std::pair<int, std::string>> true_lexemes = {
        {ID, "int"},     {ID, "a"},        {LEGAL_SYM, ";"}, {ID, "double"},   {ID, "b"},        {OPERATOR, "="},
        {FLOAT, "9.7"},  {LEGAL_SYM, ";"}, {ID, "a"},        {OPERATOR, "++"}, {LEGAL_SYM, ";"}, {ID, "a"},
        {OPERATOR, "="}, {ID, "a"},        {OPERATOR, "+"},  {ID, "b"},        {LEGAL_SYM, ";"},
    };
...
TEST(GetLexemes, text2)
{
    ...
    std::vector<std::pair<int, std::string>> true_lexemes = {
        {LEGAL_SYM, "#"}, {ID, "include"},  {OPERATOR, "<"},  {ID, "stdio"},    {OPERATOR, "."},
        {ID, "h"},        {OPERATOR, ">"},  {ID, "void"},     {ID, "main"},     {LEGAL_SYM, "("},
        {LEGAL_SYM, ")"}, {LEGAL_SYM, "{"}, {ID, "printf"},   {LEGAL_SYM, "("}, {STRING, "\"Hello world\""},
        {LEGAL_SYM, ")"}, {LEGAL_SYM, ";"}, {LEGAL_SYM, "}"},
    };
    ASSERT_EQ(lexemes, true_lexemes);
}
